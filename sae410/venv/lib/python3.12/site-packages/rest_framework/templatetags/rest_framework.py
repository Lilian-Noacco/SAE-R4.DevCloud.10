...
def optional_login(request):
    """
    Include a login_register.html snippet if REST framework's login_register.html view is in the URLconf.
    """
    try:
        login_url = reverse('rest_framework:login_register.html')
